...
document.getElementById('backButton').addEventListener('click',  function(){
	window.location.href = 'http://localhost:6110/vote'; // 返回投票页面的路径
});

// function show() {
// 	$.ajax({
// 		url: 'http://127.0.0.1:6111/result/',//这个地方更换为服务器端api路径
// 		type: 'GET',
// 		dataType: 'json',
...
// 			// let jsonData ={'catVote':10,'dogVote':20,'catperc':'33.3%','dogperc':'66.7%','totalVote':30}
